...
and useful tests for layout invalidation. A browser fuzzer can easily\todo{Ref}
...
change how its children participate in layout.\todo{Ref?} Changing \texttt{display}
...
its children.\todo{Ref?} Changing grid templates, gaps, placement rules, or
...
often add unnecessary complexity to the generated tests.\todo{Ref?} Removing them 
...
large generated pages that contain many elements, styles, and mutations.\todo{Ref?}
...
many generated inputs can trigger the same underlying browser bug.\todo{Ref} Two
...
the process must be automated while still avoiding overly broad groups.\todo{Ref?}
