...
obvious external ground truth for the correct layout of a generated page.
...
must therefore compare two ways of reaching the same final document state:
one through the normal dynamic update path and one through a fresh layout
computation.

\textbf{Solution 1}: \toolname addresses this challenge using a
self-differential testing oracle.  For each generated test case, \toolname compares the browser's normal
incremental layout after generated style changes against a from-scratch layout to identify a bug. 
